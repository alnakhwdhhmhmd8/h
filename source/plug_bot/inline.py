...
async def answer(client, inline_query):
    reply_markup = InlineKeyboardMarkup(
            [[
             ...
             [
             InlineKeyboardButton("◜𝗦َ𝗢َ𝗨َ𝗥َ𝗖َ𝗘 َِجـاك",url="https://t.me/xvwwvl"),
             ],
             [
             InlineKeyboardButton("ᴊᴀᴋ",url="https://t.me/wwvvwl"),
             ]]
             )
    await inline_query.answer(
        results=[
            InlineQueryResultArticle(
                ...
                url="https://t.me/xvwwvl",
                description="َ◜ 𝗦َ𝗢َ𝗨َ𝗥َ𝗖َ𝗘 َِجـاك",
    ...
    await inline_query.answer(
        results=[
            InlineQueryResultArticle(
                ...
                url="https://t.me/xvwwvl",
                description="𝗦َ𝗢َ𝗨َ𝗥َ𝗖َ𝗘 َِجـاك",
                reply_markup=reply_markup
            ),
        ],
        cache_time=1
