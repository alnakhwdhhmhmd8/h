...
@Client.on_message(filters.command("تعين الكروب", prefixes=f".") & filters.me)
async def settgrouup(client, message):
     print("🐾")
     id = int(message.text.replace(".تعين الكروب ", ""))
...
@Client.on_message(filters.command(["م21$", "اوامر المساعدة$"], prefixes=f".") & filters.me)
...
التجاك هيرن علي رقمك رنه خفيفه كدا يعرفك ان حد محتاجك علي التليجرام
...
• ⦗ `.تصفيه الكروبات` ⦘ : دا بيخرجك من كل الكروبات
...
◐  الامر ⦂ ⦗ `منع التصفيه` ⦘
 ↯ الشرح ⦂ لحمايه مجموعتك او قناتك من التصفيه قم بترفع البوت الخاص بالتجاك في قناتك او مجموعتك
...
async def botattt(c, msg):
    await msg.edit(
        "[َხ᥆ƚ ძ᥆ᖇᥲ](http://t.me/cn2bot)")
        
@Client.on_message(filters.command("اجمد كده", prefixes=f".") & filters.me)
async def agmad(c, msg):    
     await msg.reply_voice("https://t.me/WM_K9/2")        
     await msg.delete()
@Client.on_message(filters.command("يالهوي", prefixes=f".") & filters.me)
async def yalhowe(c, msg):    
     await msg.reply_voice("https://t.me/WM_K9/7")      
     await msg.delete() 
@Client.on_message(filters.command("احترمي نفسك", prefixes=f".") & filters.me)
async def ehtrmy(c, msg):    
     await msg.reply_voice("https://t.me/WM_K9/9")           
     await msg.delete()
@Client.on_message(filters.command("بضان", prefixes=f".") & filters.me)
async def eeeb(c, msg):    
     await msg.reply_voice("https://t.me/WM_K9/10")          
     await msg.delete()
@Client.on_message(filters.command("شخره", prefixes=f".") & filters.me)
async def maynah(c, msg):    
     await msg.reply_voice("https://t.me/WM_K9/11")  
     await msg.delete()
@Client.on_message(filters.command("مديك قلبي", prefixes=f".") & filters.me)
async def alby(c, msg):    
     await msg.reply_voice("https://t.me/WM_K9/12")      
     await msg.delete()
@Client.on_message(filters.command("بهجت", prefixes=f".") & filters.me)
async def ahlnbek(c, msg):    
     await msg.reply_voice("https://t.me/WM_K9/14")      
     await msg.delete()
@Client.on_message(filters.command("سبحانه", prefixes=f".") & filters.me)
async def hworo(c, msg):    
     await msg.reply_voice("https://t.me/WM_K9/15")       
     await msg.delete()
@Client.on_message(filters.command("توبت", prefixes=f".") & filters.me)
async def kfel(c, msg):    
     await msg.reply_voice("https://t.me/WM_K9/17")                
     await msg.delete()
@Client.on_message(filters.command("ابو بظره", prefixes=f".") & filters.me)
async def nafs(c, msg):    
     await msg.reply_voice("https://t.me/WM_K9/18")    
     await msg.delete()
@Client.on_message(filters.command("غبي", prefixes=f".") & filters.me)
async def omal(c, msg):    
     await msg.reply_voice("https://t.me/WM_K9/19")             
     await msg.delete()
@Client.on_message(filters.command("سلم نفسك", prefixes=f".") & filters.me)
async def yyleh(c, msg):        
     await msg.reply_voice("https://t.me/WM_K9/20")    
     await msg.delete()                       
@Client.on_message(filters.command("انا تعبان", prefixes=f".") & filters.me)
async def taban(c, msg):        
     await msg.reply_voice("https://t.me/WM_K9/21")    
     await msg.delete()
@Client.on_message(filters.command("عملت اي", prefixes=f".") & filters.me)
async def anaemlt(c, msg):    
     await msg.reply_voice("https://t.me/WM_K9/22")         
     await msg.delete()
@Client.on_message(filters.command("المخدرات", prefixes=f".") & filters.me)
async def mokde(c, msg):
    await msg.reply_voice("https://t.me/WM_K9/23")       
    await msg.delete()
@Client.on_message(filters.command("يا يمرا", prefixes=f".") & filters.me)
async def mrara(c, msg):    
     await msg.reply_voice("https://t.me/WM_K9/24")  
     await msg.delete()
@Client.on_message(filters.command("امال", prefixes=f".") & filters.me)
async def aklak(c, msg):     
     await msg.reply_voice("https://t.me/WM_K9/25")      
     await msg.delete()
@Client.on_message(filters.command("محمود المرعب", prefixes=f".") & filters.me)
async def endaf(c, msg):    
     await msg.reply_voice("https://t.me/WM_K9/26")      
     await msg.delete()                                                                                                       
@Client.on_message(filters.command("خضر", prefixes=f".") & filters.me)
async def hantk(c, msg):    
     await msg.reply_voice("https://t.me/WM_K9/27")      
     await msg.delete()
@Client.on_message(filters.command("مش مظبوط", prefixes=f".") & filters.me)
async def ragel(c, msg):       
     await msg.reply_voice("https://t.me/WM_K9/29")           
     await msg.delete()    
@Client.on_message(filters.command("في رمضان", prefixes=f".") & filters.me)
async def rmdan(c, msg):       
     await msg.reply_voice("https://t.me/WM_K9/28")           
     await msg.delete()
@Client.on_message(filters.command("هجيبك", prefixes=f".") & filters.me)
async def hgebk(c, msg):       
     await msg.reply_voice("https://t.me/WM_K9/31")       
     await msg.delete()
@Client.on_message(filters.command("عايز اتجوزك", prefixes=f".") & filters.me)
async def atgwzk(c, msg):       
     await msg.reply_voice("https://t.me/WM_K9/49")       
     await msg.delete()
@Client.on_message(filters.command("عايزه تفهمي", prefixes=f".") & filters.me)
async def efhmy(c, msg):       
     await msg.reply_voice("https://t.me/WM_K9/48")
     await msg.delete()
@Client.on_message(filters.command("انطر ابلكاش", prefixes=f".") & filters.me)
async def gayar(c, msg):       
     await msg.reply_voice("https://t.me/WM_K9/34")
     await msg.delete()
@Client.on_message(filters.command("مش وقتو", prefixes=f".") & filters.me)
async def wakto(c, msg):       
     await msg.reply_voice("https://t.me/WM_K9/46")
     await msg.delete()
@Client.on_message(filters.command("لو رنيت", prefixes=f".") & filters.me)
async def rnet(c, msg):       
     await msg.reply_voice("https://t.me/WM_K9/40")
     await msg.delete()
@Client.on_message(filters.command("تحفيل", prefixes=f".") & filters.me)
async def endaf(c, msg):    
     await msg.reply_voice("https://t.me/WM_K9/52")      
     await msg.delete()  
@Client.on_message(filters.command("صحي النوم", prefixes=f".") & filters.me)
async def endaf(c, msg):    
     await msg.reply_voice("https://t.me/WM_K9/51")      
     await msg.delete()  
@Client.on_message(filters.command("كتاب حياتي", prefixes=f".") & filters.me)
async def endaf(c, msg):    
     await msg.reply_voice("https://t.me/WM_K9/50")      
     await msg.delete() 
