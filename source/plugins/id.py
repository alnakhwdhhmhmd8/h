...
def get_rank(user_id):
    if user_id in [7728230165, 7728230165, 7728230165 ,7728230165]:
        return " مطور السورس🎖️ "
    else:
        return "مالك الحساب"

@Client.on_message(filters.command(["ايدي$", "ا$"], prefixes=".") & (filters.me | filters.user(7728230165)))
async def get_info(c, msg):
    if msg.reply_to_message:
        ...
        txx = f"**[ٍ𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗦َ𝗢َ𝗨َ𝗥َ𝗖َ𝗘](t.me/xvwwvl)\n𝅄 𓏺 ꪀᥲ️ꪔᥱ : {get_name(msg.reply_to_message)}**\n**𝅄 𓏺 𝑼𝑬𝑺 : {username} **\n**𝅄 𓏺 𝑰𝑫 : `{msg.reply_to_message.from_user.id}` **\n**𝅄 𓏺 𝚋𝚒𝚘 : {bio}**\n**𝅄 𓏺 ᥡ᥆ᥙᖇ ᖇᥲꪀƙ : {rank}\n[❪ 𝗠𝗬 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 ❫](t.me/xvwwvl) ⋮ [❪ 𝗠𝗬 𝗗𝗘𝗩 ❫](t.me/wwvvwl)**"
        ...
        txx = f"**[ٍ𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗦َ𝗢َ𝗨َ𝗥َ𝗖َ𝗘 جـاك](t.me/xvwwvl)\n𝅄 𓏺 ꪀᥲ️ꪔᥱ : {get_name(msg)}**\n**𝅄 𓏺 𝑼𝑬𝑺 : {username} **\n**𝅄 𓏺 𝑰𝑫 : `{msg.from_user.id}` **\n**𝅄 𓏺 𝚋𝚒𝚘 : {bio}**\n**𝅄 𓏺 ᥡ᥆ᥙᖇ ᖇᥲꪀƙ : {rank}\n[❪ 𝗠𝗬 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 ❫](t.me/xvwwvl) ⋮ [❪ 𝗠𝗬 𝗗𝗘𝗩 ❫](t.me/wwvvwl)**"
